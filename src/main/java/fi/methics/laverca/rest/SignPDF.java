...
public class SignPDF {
    ...
    private static final String REST_URL      = "https://demo.methics.fi/restapi/";
    private static final String AP_NAME       = "TestAP";
    private static final String PASSWORD      = "9TMzfH7EKXETOB8FT5gz";
    private static final String MSISDN        = "97690919096";
    ...
    private static final String SIGNED_DOC_PATH = "./examples.signed.pdf";
